...
VFL_GIT=https://github.com/zorg346/vpnface_lite
...
#echo "deb http://build.openvpn.net/debian/openvpn/release/2.5 xenial main" > /etc/apt/sources.list.d/openvpn-aptrepo.list
#apt-get update
#apt-get install -y openvpn easy-rsa

#fast fix for openvpn2.5 and easyrsa3
#get latest easy-rsa manually
wget -P /opt/ https://github.com/OpenVPN/easy-rsa/releases/download/v3.0.8/EasyRSA-3.0.8.tgz
cd /opt/ && tar xvf EasyRSA-3.0.8.tgz
mkdir /usr/share/easy-rsa
cp -r /opt/EasyRSA-3.0.8/* /usr/share/easy-rsa/
